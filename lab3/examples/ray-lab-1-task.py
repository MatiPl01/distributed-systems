...
obj_ref_arr1 = read_array.remote(os.path.abspath("../../../../../../Downloads/for-students 2/data/file_1.txt"))
print(f"array 1: {obj_ref_arr1}")

obj_ref_arr2 = read_array.remote(os.path.abspath("../../../../../../Downloads/for-students 2/data/file_2.txt"))
